...
{
	public class StoreEventRepository : IEventRepository
	{
		StoreEventContext DbContext { get; }

		static readonly object EventStoreLocker = new object();

		public StoreEventRepository(StoreEventContext context)
		{
			DbContext = context;
		}
			...
			where TAggregate : IAggregateRoot, new()
		{
			...
			IEnumerable<IEvent> events = eventEntities.AsAggregateEvents(typeof(DepartmentDeletedEvent).Assembly);
